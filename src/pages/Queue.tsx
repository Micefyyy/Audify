      ...
      <div className="flex items-center gap-3 px-4 pt-4 pb-3">
        ...
        {upcoming.length > 0 && (
          <button
            ...
            className="flex items-center gap-1 px-3 py-1.5 rounded-full text-xs text-text-muted active:bg-white/5 transition-colors"
          >
            <Trash2 size={12} />
            Clear
          </button>
      ...
      <div className="flex-1 overflow-y-auto overscroll-none pb-4">
        {currentTrack && (
          <div className="px-4 mb-4">
            <h2 className="text-xs font-semibold text-text-muted uppercase tracking-widest mb-2 px-2">Now Playing</h2>
            <div className="flex items-center gap-3 px-3 py-2.5 bg-bg-surface rounded-xl border border-white/5">
              <img
        ...
        <div className="px-4">
          <h2 className="text-xs font-semibold text-text-muted uppercase tracking-widest mb-2 px-2">
          ...
          {upcoming.length === 0 && (
            <div className="py-12 flex flex-col items-center gap-3 px-4">
              ...
              <p className="text-text-muted text-xs text-center">Queue is empty.<br />Add songs from search or your library.</p>
            </div>
          )}
